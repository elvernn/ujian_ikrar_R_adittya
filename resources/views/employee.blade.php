...
@section('content')
    <div class="bg-white p-5 shadow-inner">
        ...
        <div class="overflow-x-auto bg-gray-500 shadow-inner border rounded">
            <h1 class="p-3 font-weight-bold text-white text-sm"><i class="fa-solid fa-earth-americas"></i> Jumlah Data : {{ $count }}</h1>
            <div class="p-2">
                @if (session('success'))
